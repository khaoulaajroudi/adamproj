  ...
  return (
    <div className='dash'>
      ...
      <div className="dash_content">
         {
        lien===1?<DashHome  setlien={setlien} pdp={pdp} search={search} fnc={handleget}/>:lien===2? <Lobby   pdp={pdp}/> : lien===3? <CreateLobby setlien={setlien} />:lien===4? <DashBuy/>:lien===5?<Settings pdp={pdp}/>:null
